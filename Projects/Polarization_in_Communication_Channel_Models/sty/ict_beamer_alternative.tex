...
\setbeamertemplate{title page}
{
    ...
    %------------------------------------------------------------------------------------------------
    \vspace{-2.1mm}
    \begin{beamercolorbox}[wd=\paperwidth,ht=7.4mm,leftskip=2mm,rightskip=-0.25mm,dp=1.5mm]{frametitle}
        \hfill
        \begin{minipage}{0.21\paperwidth}
            \vspace{-4.25mm}
    ...
    % Dark gray box
    %------------------------------------------------------------------------------------------------
    \begin{beamercolorbox}[wd=\paperwidth,ht=10mm,leftskip=2mm,dp=10mm, rightskip = 0.5mm]{frametitle} % changed 'title' to frametitle [nd]
...
%------------------------------------------------------------------------------------------------
    ...
    \begin{beamercolorbox}[wd=\paperwidth,ht=1.0mm,leftskip=3mm,dp=3.5mm]{white} % changed 'framesubtitle' to 'white' [nd]
        ...
        \begin{minipage}[t][0.25cm][c]{17mm}
            \bfseries
            \scalebox{0.9}{Information and} \\
            \scalebox{0.9}{Coding Theory}
        \end{minipage}
        %
        \hspace{3mm}
        %
