...
# Updated Version of Damn Vulnerable Model Context Protocol (DVMCP)
-SSE vs Regular Server Inconsistency fixed.
-Some challenges edited to make scenarios more realistic.
-Some challenges had errors such as resources not being accessible (fixed).
[See the detailed change log under CHANGES.md](CHANGES.md)
...
## Updates/fixes
Project updated to be more realistic and error-fixed by Fatih Corumluoglu using Claude, Copilot and Gemini.
