...
ADMIN_DIAG_TOKEN = "/tmp/dvmcp_challenge10/config/diagnostic_key.txt"
if not os.path.exists(ADMIN_DIAG_TOKEN):
    with open(ADMIN_DIAG_TOKEN, "w") as f:
...
def run_system_diagnostic(component: str = "all", auth_key: str = "") -> str:
    ...
    try:
        with open(ADMIN_DIAG_TOKEN, "r") as f:
