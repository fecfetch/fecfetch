...
""")
        ...
        @self.mcp.resource("system://api_keys")
...
"""
        ...
        # Store resource getter functions for access via tools
        self.resource_getters = {
            "system://api_keys": get_api_keys,
            "documents://list": list_documents,
            "uploads://list": list_uploads
        }

        # Add a tool to list all resources
        @self.mcp.tool()
        def list_resources() -> str:
            ...
            return """
Available Resources:
- documents://list - List available system documents
- uploads://list - List user uploaded documents  
- system://api_keys - System API keys (RESTRICTED ACCESS)
"""

        # Add a tool to access resources
        @self.mcp.tool()
        def get_resource(resource_uri: str) -> str:
            """Access an MCP resource by its URI.
            ...
            """
            if resource_uri in self.resource_getters:
                return self.resource_getters[resource_uri]()
            else:
                return f"Error: Resource '{resource_uri}' not found."
